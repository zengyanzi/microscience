 ...
 */
class WPAL_Model_List extends WPAL_Model {
	...
	public function convertRecords($elementClass = NULL, $includeFields = NULL) {
		...
		if ( ! is_subclass_of($elementClass, WPAL_Plugin::PREFIX . 'Model_Record')) {
			throw new Exception("Provideded class name $elementClass must be a subclass of " . WPAL_Plugin::PREFIX . 'Model_Record');
		}
