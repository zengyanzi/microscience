...
function wpal_plugins_api($res, $action, $args)
{
	if (false === $res and 'plugin_information' == $action and isset($args->slug) and 'WPAL_Plugin' == $args->slug) {
		$raw_response = wp_remote_get(WPAL_Plugin::getInstance()->getOption('info_api_url'));
