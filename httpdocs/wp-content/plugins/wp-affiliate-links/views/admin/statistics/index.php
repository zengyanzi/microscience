...
<div class="wrap">
	<h2><?php _e('WP Affiliate Links Statistics', 'wpal_plugin') ?></h2>
	...
	<div class="clear"></div>
	<table class="widefat wpal-admin-statistics">
		<thead>
		<tr>
			<?php
			$col_html = '';
		...
		<tbody id="the-wpal-admin-statistics-list" class="list:wpal-admin-statistics">
		<?php if ($list->isEmpty()): ?>
			<tr>
				<td colspan="<?php echo count($columns) ?>"><?php _e('No links found.', 'wpal_plugin') ?></td>
			</tr>
		<?php else: ?>
			<?php $class = ''; ?>
						...
						switch ($column_id):
							...
							case 'name':
								...
								<td>
									<strong>
										<?php if ('' != $item['name']): ?>
											<a href="<?php echo esc_url(add_query_arg(array('page' => 'wpal-admin-statistics', 'id' => $item['id']), admin_url('admin.php'))) ?>"><?php echo $item['name'] ?></a>
										<?php else: ?>
											<?php _e('no title', 'wpal_plugin') ?>
										<?php endif ?>
									</strong>
	...
	<div class="tablenav">
		<div class="alignleft actions links">
			...
			<a href="<?php echo esc_url(add_query_arg(array('page' => 'wpal-admin-statistics', 'action' => 'export'), admin_url('admin.php'))) ?>"><?php _e('All Data', 'wpal_plugin') ?></a>
		</div>
