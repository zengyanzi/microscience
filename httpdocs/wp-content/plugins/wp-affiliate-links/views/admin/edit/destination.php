...
<div class="wrap">
	...
	<table class="form-table dest destination-set">
		...
		<tr>
			<td><a href="#add" title="<?php _e('add', 'wpal_plugin')?>" class="action">Add Another URL</a></td>
			<td class="action auto"><a href="#auto" title="<?php _e('auto adjust weights', 'wpal_plugin')?>"><span class="ui-icon ui-icon-refresh">%</span></a></td>
			<td></td>
		</tr>
	</table>
	<p>
		...
		<input class="button-primary" type="submit" value="<?php echo esc_attr(__('Save Destination Set'), 'wpal_plugin') ?>" />
		or
		<input class="button" type="submit" name="clear" value="<?php echo esc_attr(__('Clear'), 'wpal_plugin') ?>" />
	</p>
	</form>
