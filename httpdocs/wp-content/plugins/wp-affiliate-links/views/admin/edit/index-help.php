...
<p>
WP Affiliate Links allows you to choose which redirect type used for each Link. The default is a 301 redirect. This is the most common type of HTTP redirect.
</p>
...
<br />
<i>ReferrerMask</i> - Will not redirect the visitor unless WP Affiliate Links determines the referrer has been wiped successfully. Useful for hiding your referrer from dishonest merchants.<br />
</p>

<b>Advanced Option: Link Expiration</b>

<p>
Link Expires - check this box to make the Link stop working after a certain date. After the Link has expired, you can choose to show visitors a 404 Not Found error page (not recommended), or redirect them to a page saying the Link/offer has expired by specifying the URL of that page. You could even redirect the user to another WP Affiliate Links-created Link by specifying the Link URL.
</p>
...
<center>
	...
	<h2 id="tutorial_video" class="toggler " style="display:none;">
